...
<body>
  ...
  <div class="await-message">
    <p><span class="bold">以下の内容で注文を受け付けました！</span></p> 
    <p><span class="red">＞＞ この画面はお会計の完了まで＜＜</span></p>
    <p><span class="red">＞＞ スクリーンショット等で保管しておいてください＜＜</span></p>
  </div>
  ...
  <p class="bold">No. <%=docked_number%>　<%= user_name %> さん</p><div class="space"></div>
